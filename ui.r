...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    title = "Menu",
    sidebarMenu(
      menuItem("Gérer les données",
        tabName = "dash", icon = icon("fas fa-chart-bar"),
        tagList(
          fileInput(
            inputId = "file1",
  ...
  dashboardBody(
    ...
    tabItem(
      ...
      fluidRow(
                ...
                wellPanel(
                  fluidRow(
                    ...
                    box(width = 3, column(
                      ...
                      fileInput(
                        inputId = "file1", label = "Veuillez charger le jeu de données",
                        multiple = TRUE,
                        accept = c(
                          "text/csv", ".xlsx", ".xls", ".tsv",
                            ...
                            tabPanel(
                              ...
                              box(
                                ...
                                box(
                                  ...
                                  wellPanel(
                                    h5(
                                      "Cette section sera consacrée analyse exploratoire de données  basée sur le dataset HR Analytics: Job Change of Data Scientists",
        ...
        Cette prédiction permettrait de réduire les coûts de formationet de planifier la catégorisation des candidats.",
                                    )
                                ...
                                tabsetPanel(
                                  tabPanel(
                                    "Analyse Univariée",
                                    fluidRow(box(
                                      width = 12, title = "Variables Quantitatives",
                                    ...
                                    br(),
                                    fluidRow(box(
                                      width = 12, title = "Variables Qualitatives",
                                      column(
                                        12,
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("dist2", height = 300),
  ...
  Colonnes avec peu de valeurs manquantes: À l'inverse, d'autres colonnes comme enrallee_Id semblent avoir très peu, voire aucune, valeur manquante. Ces colonnes sont donc plus complètes et pourraient être plus fiables pour l'analyse.", collapsible = T
                                    ...
                                    fluidRow(
                                      column(
                                        6,
                                        box(
                                          width = 12, plotOutput("plot2", height = 300),
  ...
  Les autres disciplines, comme les arts, le commerce et les humanités, sont peu représentées. Cela peut limiter la diversité des perspectives dans le domaine, même si les profils non-STEM apportent souvent des compétences complémentaires utiles dans certains aspects de l'analyse de données.", collapsible = T
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("plot4", height = 500),
                      ...
                      a temps plein et des cours a temps partiel.",
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("plot5", height = 500),
                  ...
                  85% ont poursuivi des etudes superieures.", collapsible = T
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("plot6", height = 500),
                                    ...
                                    fluidRow(
                                      box(
                                        width = 6, plotOutput("plot17", height = 500),
  ...
  Hétérogénéité des tailles: La distribution est assez hétérogène, avec des pics pour certaines classes de taille et des creux pour d'autres..
                                      ...
                                      box(
                                        width = 6, plotOutput("plot18", height = 500),
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("plot19", height = 500),
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("plot20", height = 500),
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("plot21", height = 500),
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("plot22", height = 500),
  ...
  "))
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("plot23", height = 500) %>% withSpinner(type = 6, color = "#87CEEB"),
  ...
  ", collapsible = T
                                    ...
                                    fluidRow(
                                      box(
                                        width = 12, plotOutput("plot3", height = 300),
                      ...
                      pour chaque niveau d'etudes avoir une experience pertiante est plus frequent.", collapsible = T
                            ...
                            tabPanel(
                              ...
                              fluidRow(
                                box(
                                  ...
                                  column(
                                    4,
                                    box(width = 12, title = "Gérer les valeurs manquantes", column(
                                      12,
                                  ...
                                  column(
                                    2,
                                    box(width = 12, title = "Normalisation", column(
                                      12,
                                      # Bouton pour gérer les valeurs manquantes
                                  ...
                                  column(
                                    4,
                                    box(width = 12, title = "Déséquilibre des classes", column(
                                      12,
                        ...
                        tabPanel(
                          ...
                          tabsetPanel(
                            tabPanel(
                              "Méthode d'anlyse factorielle",
                              fluidRow(box(
                                width = 12, title = "identification des variables les plus importantes bien que n'étant pas une uné méthode d'analyse factorielle, nous prévoyons comparer les résultats à ceux de l'ACP dans le but de mieux commenter et critiquer les résultats de l'ACP!",
                                h4("Sélection de variables : importance de chaque variable"),
                                wellPanel(
                                  h5(
                                    "Bienvenue dans la section basée sur le dataset HR Analytics: Job Change of Data Scientists",
                                    tags$br(), tags$br(),
                                  ...
                                  h5(
                                    "On observe ainsi que la feature ayant le plus d'impact est le 'City development index' qui mesure le développement des villes, indicateur qui permet de classer les villes du monde.",
                                    tags$br(),
                            ...
                            tabPanel(
                              ...
                              fluidRow(box(
                                width = 12, title = "Centres mobiles",
                                h4("Centres mobiles"),
                                wellPanel(
                                  "",
