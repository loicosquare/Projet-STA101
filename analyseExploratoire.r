...
applyAnalyseExoloratoire <- function(hr_data, session, output) {
  if (!is.null(hr_data)) {
    ...
    shinyalert("Chargement du jeu de données!", "Le chargement du jeu de données est terminé, vous pouvez maintenant parcourir les différentes sections et visualiser les graphiques", type = "success")
  } else {
